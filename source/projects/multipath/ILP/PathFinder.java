...
public class PathFinder {
	...
	public static double trueDistance(Graph g,int start,int goal){
	...
	protected static Path findOneShortestPath(Graph g, int start, int goal,
		...
		if(g.idVertexMap.get(goal)==null){
			System.out.printf("goal %d cannot be found!\n",goal);
			System.out.printf("%d\n",g.idVertexMap.get(goal).id);
			System.exit(0);
		}

		if(g.idVertexMap.get(start)==null){
			System.out.printf("start %d cannot be found!\n",start);
			System.out.printf("%d\n",g.idVertexMap.get(start).id);
			System.exit(0);
		}
		...
		while (!queueMap.isEmpty()) {
			...
			if(is==null){
				System.out.printf("(%d,%d)\n",g.idVertexMap.get(vId).getIX(),g.idVertexMap.get(vId).getIY());
				System.out.printf("%d\n",g.adjacencySetMap.get(vId).size());
				System.out.printf("Cannot find vid");
